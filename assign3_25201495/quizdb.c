...
// defining QuizQ as static to limit scope to .c file
static char* QuizQ[] = {
...
/** API for access to Quiz information **/
char** get_quiz_questions() {
    return QuizQ;
}

char** get_quiz_answers() {
    return QuizA;
}

int get_quiz_size() {
    return sizeof(QuizQ) / sizeof(QuizQ[0]);
}
